...
class LoaderTest {
  ...
  public function loadsSingleFile(Assert $assert): void {
    ...
    $this->assertExpectedFiles($assert, Vector {$this->fileDir.'/file1'});
  }
  ...
  public function loadsMultipleFiles(Assert $assert): void {
    ...
    $this->assertExpectedFiles(
      $assert,
      Vector {$this->fileDir.'/file1', $this->fileDir.'/file2'},
    );
  }

  private function assertExpectedFiles(
    Assert $assert,
